Sub S02_SelectBlocosProducao(ByRef pOrdem, ByRef pInverteOrdem, ByRef pFiltroPN, ByRef pFiltroDataInicial, ByRef pFiltroDataFinal)
'////////////////////////////////////////////////////////////////
' Seleciona dados e ordena de acordo com o pedido do usuario
...
'DECLARACAO DE TAGs
Dim conn, rst, SQL_Table, strAscDesc, i, j, strFuncName, Data

On Error Resume Next

strFuncName = "S02_SelectBlocosProducao"
...
If ((pInverteOrdem = 1) And (pOrdem = SmartTags("nOrdem"))) Then
	...
	STD_Log "Inverteu Ordem. Asc=" & CStr(SmartTags("nAscDesc"))
End If
...
If Not (rst.EOF And rst.BOF) Then 
	...
	STD_Log "Retornou Dados Válidos"
